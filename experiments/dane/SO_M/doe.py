...
instance_level_1 = {
    ...
    'job_request_cores_per_task': [1,14], # What a job requests in terms of resources, is needed for the flux bulksubmit for each job, as well as for the flux alloc instantiation
...
instance_level_2 = {
    ...
    #'instance_slots': [28],  # half of the resources
    'match_policy': ['first', 'low'],   
    # 'match_policy': ['first'],   
    # 'match_policy': ['first', 'low', 'high', 'locality'],   
    'queue_policy': ['fcfs', 'hybrid'],
